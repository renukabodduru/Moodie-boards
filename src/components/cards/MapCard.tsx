...
export const MapCard: React.FC<{ object: CanvasObject }> = ({ object }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-between relative bg-slate-900 text-white rounded-xl overflow-hidden p-3">
      ...
      <div className="relative z-10 flex items-center gap-2 bg-slate-800/80 backdrop-blur rounded-xl p-1.5 border border-slate-700">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center my-4">
        ...
        <span className="text-xs font-bold mt-1 text-slate-200">{location}</span>
      </div>
