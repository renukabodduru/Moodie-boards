  ...
  return (
    <div className="w-full h-full flex items-center justify-center">
      <textarea
        ...
        className="w-full h-full bg-transparent resize-none focus:outline-none text-3xl font-black tracking-tighter focus:ring-1 focus:ring-neutral-400 rounded px-1 overflow-hidden flex items-center"
